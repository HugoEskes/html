...
$sql = "INSERT INTO admins (naam, wachtwoord, email) VALUES ('$name_admin1', '$hashed_admin1', '$email_admin1')";
...
$sql = "INSERT INTO admins (naam, wachtwoord, email) VALUES ('$name_admin2', '$hashed_admin2', '$email_admin2')";
mysqli_query($connection, $sql);
...
$sql = "INSERT INTO admins (naam, wachtwoord, email) VALUES ('$name_admin3', '$hashed_admin3', '$email_admin3')";
mysqli_query($connection, $sql);
...
$sql = "INSERT INTO admins (naam, wachtwoord, email) VALUES ('$name_admin4', '$hashed_admin4', '$email_admin4')";
mysqli_query($connection, $sql);
...
$sql = "INSERT INTO admins (naam, wachtwoord, email) VALUES ('$name_admin5', '$hashed_admin5', '$email_admin5')";
mysqli_query($connection, $sql);
