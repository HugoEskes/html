        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="loggedin-about.php" class="nav-item nav-link active">About us</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">My Ski. I. P</a>
                        <div class="dropdown-menu text-capitalize">
                            <a href="loggedin-account.php" class="dropdown-item">Account</a>
                            <a href="loggedin-myreservations.php" class="dropdown-item active">My Reservations</a>
